...
const MAX_REQUESTS_PER_WINDOW = 5;    // 5 requests per minute (Optimized for Gemini Free Tier's 15 RPM global limit)
const MAX_DAILY_REQUESTS = 50;        // 50 requests per day (Allows ~30 active daily users on free tier)
